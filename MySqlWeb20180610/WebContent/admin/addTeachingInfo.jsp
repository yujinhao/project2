		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<div class="bbD">学生数量<span class="f_cB">&nbsp;*</span><input id="StudentsNumber" name="StudentsNumber" class="input3" /></div>
					<div class="bbD">
						<p class="bbDP">
							<button class="btn_ok btn_yes" type="submit" onClick="return check();">确认添加</button>
							<a class="btn_ok btn_no" href="addTeachingInfo.jsp">取消</a>
						</p>
					</div>
				</div>			
				</form>
