	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form action="updateStudentGradeServlet">
                        <%
                        	String StudentId = request.getParameter("StudentId");
                            String CourseId = request.getParameter("CourseId");
							Vector<ScoreDTO> v = new Vector<ScoreDTO>();
							v = (Vector<ScoreDTO>)session.getAttribute("allstugrade");
				...
				<div class="baBody">
					...
					<div class="bbD">分数：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <input name="Grade" value=<%=s.getGrade() %> class="input3" />
					</div>
					<div class="bbD">绩点：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <input name="GradePoint" value=<%=s.getGradePoint() %> class="input3" />
					</div>
					<div class="bbD">
						<p class="bbDP">
							<button class="btn_ok btn_yes" type="submit">确认修改</button>
							<a class="btn_ok btn_no" href="findAllStudentGradeServlet">取消</a>
						</p>
					</div>
				</div>
                         <%
