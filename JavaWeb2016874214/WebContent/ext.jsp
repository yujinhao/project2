...
<div id="c2" class="content">修改房间</div>
<div id="c3" class="content"><table width="834" border="0" cellpadding="0" cellspacing="0">
		<tr>			
	...
	<table width="600" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td height="30" colspan="3"><table width="100%" border="1"
					...
					<tr>
						<td width="25%" height="20" align="center" bgcolor=""><span
							class="txt"><span class="titletxt">房号</span></span></td>
						<td width="25%" height="20" align="center" bgcolor=""
							class="titletxt"> 用户</td>
						<td width="25%" height="20" align="center" bgcolor=""
					...
					<tr>
						<td width= "25%" height="20" align="center" bgcolor=""><span
							class="txt">r104</span></td>
						<td width="25%" height="20" align="center" bgcolor=""><span
							class="txt">周柏豪</span></td>
						<td width="25%" height="20" align="center" bgcolor=""><span
							class="txt">yes</span></td>
						<td width="25%" height="20" align="center" bgcolor=""
							class="titletxt">198</td>
					</tr>
	...
	<table width="600" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="1"
					align="center" cellpadding="0" cellspacing="0">
					<tr>
					    <td width="10%" align="center" bgcolor="" class="titletxt">选择</td>
				
						<td width="25%" height="30" align="center" bgcolor=""><span
							class="txt"><span class="titletxt">房间ID</span></span></td>
						<td width="30%" height="30" align="center" bgcolor=""
							class="titletxt">房间类型</td>
						<td width="35%" height="30" align="center" bgcolor=""
					...
					%>
					<tr>
					    <td  width="15%"  height="30" align="center" value="" /></td>
						<td width="25%" height="30" align="center" bgcolor=""><span
							class="txt"><%=rm.getRid()%></span></td>
						<td width="30%" height="30" align="center" ><span
							class="txt"><%=rm.getRtype()%></span></td>
						<td width="35%" height="30" align="center" bgcolor=""><span
							class="txt">
